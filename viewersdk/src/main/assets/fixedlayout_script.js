...
function getElementInfoFromSelection(filePath){  // TODO :: new custom selection - added
	...
	window.ttsDataInfo.setSelectedElementPath(startElementPath, startCharOffset, filePath);
}
